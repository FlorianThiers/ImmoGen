...
interface OutdoorSectionAppartmentProps {
...
const OutdoorSectionAppartment: React.FC<OutdoorSectionAppartmentProps> = ({
  formData,
  handleChange,
}) => {
  return (
    <div className="grid-container">
      ...
      <FormField label="Verdieping:">
        <InputField
          type="number"
          name="floor"
          value={formData.floor || ""}
          onChange={handleChange}
          title="Voer de verdieping in"
          placeholder="Welk verdiep"
          min={0}
          required
        />
      </FormField>
...
export default OutdoorSectionAppartment;
